...
export default function RoutineFormModal({
  ...
  function handleSave() {
    ...
    const totalSec = movements.reduce(
      (acc, m) =>
        ...
        <View style={s.modalContainer}>
          ...
          <View style={s.modalHeader}>
            ...
            <TouchableOpacity
              ...
              hitSlop={{ top: 12, bottom: 12, left: 12, right: 12 }}
            >
              <Text style={[s.modalCancel, { color: C.blue }]}>
                {isEdit ? "Save" : "Add"}
              </Text>
            </TouchableOpacity>
          </View>
          ...
          >
            ...
            <TextInput
              style={[
                s.input,
                { height: 120, textAlignVertical: "top", paddingTop: 14 },
              ]}
                ...
                return (
                  ...
                  >
                    <Ionicons
                      ...
                      size={26}
                      color={sel ? cat.color : C.textMuted}
                    />
                    <Text
                      style={[
                        s.iconLabel,
                        { color: sel ? cat.color : C.textDim },
                      ]}
                    >
                      {cat.label}
                    </Text>
